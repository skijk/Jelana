...
<header class="site-header"><div><p class="eyebrow">JELLYFIN LIBRARY</p><h1>Fulflix Stats</h1></div><div class="header-tools"><button class="settings-button" type="button" aria-label="Anpassa dashboard" title="Anpassa dashboard">⚙</button><div class="status-pill" title="Dashboard data is refreshed at most once per hour by the cron job"><span class="status-dot"></span><span class="status-text"><strong>Cachedata</strong><small>Updated <?=e($updatedAt->format('H:i'))?></small></span></div></div></header>
...
<article class="panel new-panel v2-new-panel" data-new-panel>
    <div class="new-panel-header">
        ...
        <div class="ranking-tabs" role="tablist" aria-label="Select time range för nya titlar">
...
<article class="panel"><div class="panel-heading"><p>ANVÄNDARE</p><h2>Mest aktiva · 7 days</h2></div><?php renderUsers($activeUsers7);?></article>
<article class="panel"><div class="panel-heading"><p>ANVÄNDARE</p><h2>Mest aktiva · 30 days</h2></div><?php renderUsers($activeUsers30);?></article>
<article class="panel"><div class="panel-heading"><p>PLAYBACK</p><h2>Metod · 30 days</h2></div><?php renderBreakdown($methods);?></article>
<article class="panel"><div class="panel-heading"><p>CLIENTS</p><h2>Vanligast · 30 days</h2></div><?php renderBreakdown($clients);?></article>
</section>
...
<article class="panel"><div class="panel-heading"><p>VIDEO</p><h2>Resolutionar</h2></div><?php renderBreakdown(associativeRows($mediaProfile['Resolution']??[]));?></article>
